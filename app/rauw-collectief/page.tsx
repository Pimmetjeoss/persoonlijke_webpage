...
export default function RauwCollectiefPage() {
  ...
  return (
    <main className="min-h-screen" style={{ background: "hsl(138.5 76.5% 96.7%)" }}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 space-y-16" ref={contentRef}>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h1
                  className="text-5xl font-sans font-normal uppercase tracking-tight"
              ...
              {[
                ...
                <span
                  ...
                  style={{
                    ...
                    background: "hsl(140.6 84.2% 92.5%)",
                  }}
                >
                  {tag}
                </span>
            ...
            <div
              ...
              style={{ color: "hsl(142.1 70.6% 45.3%)" }}
            >
              <MapPin size={14} />
              <span>Spoorlaan 64A, Oss · <a href="https://rauwcollectief.nl" target="_blank" rel="noopener noreferrer" style={{ color: "hsl(142.1 76.2% 36.3%)" }}>rauwcollectief.nl</a></span>
            </div>
          </div>
        </SectionCard>
        ...
        <div className="space-y-4">
          <h2
            className="text-2xl font-sans font-normal uppercase tracking-wider"
            style={{ color: "hsl(144.9 80.4% 10%)" }}
          >
