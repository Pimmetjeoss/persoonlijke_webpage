...
1. **Spot-capaciteit** – Beschikbaar wanneer er vrije GPU's zijn, goedkoper maar onbetrouwbaar. Ideaal voor experimentele workloads.
2. **Gereserveerde contracten** – Klanten leggen zich vast voor maanden of jaren, betalen een vaste prijs, en krijgen gegarandeerde toegang. Dit is de heilige graal voor een neocloud, want het geeft voorspelbare inkomsten.
